...
<html xmlns="http://www.w3.org/1999/xhtml">
   ...
   <body>
      ...
      <div class="bg">
        <aside class="left-sidebar teacher" style="justify-content:center;">
                    ...
                    <a href="dash.php?q=0">
                        <div class="left-sidebar-content">
                            <div style="display:flex; align-items:center; justify-content:space-between">
                                <img src="image/quizz-icon.svg" alt="" style="height: 10vh; margin-right: 10px;">
                                <a href="dash.php?q=0"  style="color: rgb(213, 29, 78); text-decoration: none;">Home<span class="sr-only">(current)</span></a>
                            </div>
                        </div>
                    </a>
               </div>
               <div <?php
                ...
                <div class="left-sidebar-item">
                    <a href="dash.php?q=1">
                        <div class="left-sidebar-content">
                            <div style="display:flex; align-items:center; justify-content:space-between">
                                <img src="image/students.jpg" alt="" style="height: 10vh; margin-right: 10px">
                ...
                <div class="left-sidebar-item">
                    <a href="dash.php?q=2">
                        <div class="left-sidebar-content">
                            <div style="display:flex; align-items:center; justify-content:space-between">
                                <img src="image/leader-board.jpg" alt="" style="height: 10vh; margin-right: 10px">
                ...
                <div class="left-sidebar-item">
                    <a href="dash.php?q=4">
                        <div class="left-sidebar-content">
                            <div style="display:flex; align-items:center; justify-content:space-between">
                                <img src="image/add-quiz.png" alt="" style="height: 10vh; margin-right: 10px">
                ...
                <div class="left-sidebar-item">
                    <a href="dash.php?q=5">
                        <div class="left-sidebar-content">
                            <div style="display:flex; align-items:center; justify-content:space-between">
                                <img src="image/remove-quiz.jpg" alt="" style="height: 10vh; margin-right: 10px">
            ...
            <div class="col-md-12">
               <?php
                  if (@$_GET['q'] == 0) {
                      ...
                      echo '<div class="panel" style="margin-top:20vh"><table class="table table-striped title1"  style="vertical-align:middle">
                  ...
                  if (@$_GET['q'] == 2) {
                      ...
                      echo '<div class="panel title" style="margin-top:20vh">
                  <table class="table table-striped title1" >
                  <tr><td style="vertical-align:middle"><b>Rank</b></td><td style="vertical-align:middle"><b>Name</b></td><td style="vertical-align:middle"><b>Cohort</b></td><td style="vertical-align:middle"><b>HAN ID</b></td><td style="vertical-align:middle"><b>Roll</b></td><td style="vertical-align:middle"><b>Gender</b></td><td style="vertical-align:middle"><b>Score</b></td></tr>';
                      $c = $showfrom-1;
                  ...
                  if (@$_GET['q'] == 1) {
                      ...
                      echo '<div class="panel" style="margin-top:20vh"><table class="table table-striped title1">
                  <tr><td style="vertical-align:middle"><b>S.N.</b></td><td style="vertical-align:middle"><b>Name</b></td><td style="vertical-align:middle"><b>Gender</b></td><td style="vertical-align:middle"><b>Roll</b></td><td style="vertical-align:middle"><b>Cohort</b></td><td style="vertical-align:middle"><b>HAN ID</b></td></tr>';
                      $c = 1;
                      while ($row = mysqli_fetch_array($result)) {
                          $name      = $row['name'];
                          $gender    = $row['gender'];
                          ...
                          echo '<tr><td style="vertical-align:middle">' . $c++ . '</td><td style="vertical-align:middle">' . $name . '</td><td style="vertical-align:middle">' . $gender . '</td><td style="vertical-align:middle">' . $rollno . '</td><td style="vertical-align:middle">' . $branch . '</td><td style="vertical-align:middle">' . $username1 . '</td>
                  ...
                  if (@$_GET['q'] == 3) {
                      ...
                      echo '<div class="panel" style="margin-top:20vh"><table class="table table-striped title1">
                  <tr><td style="vertical-align:middle"><b>S.N.</b></td><td style="vertical-align:middle"><b>Subject</b></td><td style="vertical-align:middle"><b>HAN ID</b></td><td style="vertical-align:middle"><b>Date</b></td><td style="vertical-align:middle"><b>Time</b></td><td style="vertical-align:middle"><b>By</b></td><td style="vertical-align:middle"></td><td style="vertical-align:middle"><b>Action</b></td></tr>';
                      $c = 1;
                      while ($row = mysqli_fetch_array($result)) {
                          $date      = $row['date'];
                  ...
                  if (@$_GET['fid']) {
                      ...
                      while ($row = mysqli_fetch_array($result)) {
                          ...
                          echo '<div class="panel" style="margin-top:20vh"><a title="Back to Archive" href="update.php?q1=2"><b><span class="glyphicon glyphicon-level-up" aria-hidden="true"></span></b></a><h2 style="text-align:center; margin-top:-15px;font-family: "Ubuntu", sans-serif;"><b>' . $subject . '</b></h1>';
                  ...
                  if (@$_GET['q'] == 4 && !(@$_GET['step'])) {
                      echo ' 
                  <div class="row">
                  <span class="title1" style="margin-left:40%;font-size:30px;"><b style="color:#fff">Enter Quiz Details</b></span><br /><br />
