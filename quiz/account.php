...
<html xmlns="http://www.w3.org/1999/xhtml">
   ...
   <body>
      ...
      <div class="bg">
        <aside class="left-sidebar student" style="justify-content:center">
            <div class="left-sidebar-container" style="text-align: center;">
                <!-- Item 1 -->
                <div class="left-sidebar-item">
                    <a href="account.php?q=1">
                        <div class="left-sidebar-content">
                            <div style="display:flex; align-items:center; justify-content:center">
                                <img src="image/quizz-icon.svg" alt="" style="height: 30vh;">
                            </div>
                        </div>
                    </a>
                </div>
                ...
                if (@$_GET['q'] == 1)
                    echo 'class="active"';
                ?> ><a href="account.php?q=1" style="color: rgb(213, 29, 78); text-decoration: none;">Quizz Game</a></div>
                ...
                <div class="left-sidebar-item">
                    <a href="account.php?q=2">
                        <div class="left-sidebar-content">
                            <div style="display:flex; align-items:center; justify-content:center">
                                <img src="image/open-book.svg" alt="" style="height: 40vh;">
                            </div>
                        </div>
                    </a>
                </div>
                ...
                if (@$_GET['q'] == 2)
                    echo 'class="active"';
                ?>><a href="account.php?q=2" style="color: rgb(213, 29, 78); text-decoration: none;">&nbsp;My History</a></div>
            </div>
        </aside>
         ...
         <div class="container">
            <div class="row">
            <div class="panel2" style="text-align: center;">It's Quizz Time!</div>
...
">
                  ...
                  <?php
                     ...
                     <tr><td style="vertical-align:middle"><b>S.N.</b></td><td style="vertical-align:middle"><b>Name</b></td><td style="vertical-align:middle"><b>Total question</b></td><td style="vertical-align:middle"><b>Correct Answer</b></td><td style="vertical-align:middle"><b>Wrong Answer</b></td><td style="vertical-align:middle"><b>Total Marks</b></td><td style="vertical-align:middle"><b>Time limit</b></td><td style="vertical-align:middle"><b>Action</b></td></tr>';
                       ...
                       <td style="vertical-align:middle"><b><a href="account.php?q=quiz&step=2&eid=' . $eid . '&n=1&t=' . $total . '&start=start" class="btn" style="color:#FFFFFF;background:rgb(38, 137, 12);font-size:12px;padding:7px;padding-left:34px;padding-right:34px"><b>Start</b></span></a></b></td></tr>';
                             } else {
                       ...
                       <td style="vertical-align:middle"><b><a href="account.php?q=quiz&step=2&eid=' . $eid . '&n=1&t=' . $total . '&start=start" class="btn" style="margin:0px;background:darkorange;color:white">&nbsp;<span class="title1"><b>Continue</b></span></a></b></td></tr>';
                                     ...
                                     echo '<tr style="color:darkgreen"><td style="vertical-align:middle">' . $c++ . '</td><td style="vertical-align:middle">' . $title . '&nbsp;<span title="This quiz is already solve by you" class="glyphicon glyphicon-ok" aria-hidden="true"></span></td><td style="vertical-align:middle">' . $total . '</td><td style="vertical-align:middle">+' . $correct . '</td><td style="vertical-align:middle">-' . $wrong . '</td><td style="vertical-align:middle">' . $correct * $total . '</td><td style="vertical-align:middle">' . $time . '&nbsp;min</td>
                       <td style="vertical-align:middle"><b><a href="account.php?q=result&eid=' . $eid . '" class="btn" style="margin:0px;background:rgb(19, 104, 206);color:white">&nbsp;<span class="title1"><b>View Result</b></span></a></b></td></tr>';
                                 }
                             }
                         }
                         $c = 0;
                  ...
                  <?php
                     ...
                     var countdownTimer = setInterval(\'secondPassed()\', 1000);
                                 ...
                                 echo '<font size="3" style="margin-left:100px;font-family:\'typo\' font-size:20px; font-weight:bold;color:#fff">Time Left : </font><span class="timer btn" style="margin-left:20px; background-color: rgb(19, 104, 206);"><font style="font-family:\'typo\';font-size:20px;font-weight:bold;color:#fff" id="countdown"></font></span><span class="timer btn" style="margin-left:50px; background-color: rgb(38, 137, 12); color:#fff;" onclick="end()"><font style="font-size:20px;font-weight:bold;">Submit</font></span>';
                                 $eid   = @$_GET['eid'];
                                 $sn    = @$_GET['n'];
                                 $total = @$_GET['t'];
                                 $q     = mysqli_query($con, "SELECT * FROM questions WHERE eid='$eid' AND sn='$sn' ");
                                 echo '<div class="panel" style="margin-right:5%;margin-left:5%;margin-top:10px;border-radius:10px; background-color:transparent; border:none;">';
                                 while ($row = mysqli_fetch_array($q)) {
                                     $qns = stripslashes($row['qns']);
                                     $qid = $row['qid'];
                                     echo '<b><pre style="background-color:#fff; text-align:center; box-shadow: rgba(0, 0, 0, 0.15) 0px -4px 0px 0px inset;"><div style="font-size:20px;font-weight:bold;font-family:calibri;margin:10px;";>Question ' . $sn . ': <br> ' . $qns . '</div></pre></b>';
                                 }
                     ...
                     <br />';
                                 ...
                                 while ($row = mysqli_fetch_array($q)) {
                                     ...
                                     echo '<div class="funkyradio-success"><input type="radio" id="' . $optionid . '" name="ans" value="' . $optionid . '" onclick="enable()"> <label for="' . $optionid . '" class="green" style="width:100%; background-color: rgb(226, 27, 60);"><div style="color:#fff;font-size:20px;word-wrap:break-word; font-weight:bold; padding: 16px 0;">&nbsp;&nbsp;' . $option . '</div></label></div>';
                                 }
                                 echo '</div>';
                                 if ($_GET["t"] > $_GET["n"] && $_GET["n"] != 1) {
                                     echo '<br /><a href="account.php?q=quiz&step=2&eid=' . $eid . '&n=' . ($sn - 1) . '&t=' . $total . '" class="btn" style="height:30px; background-color:rgb(19, 104, 206); color:#fff;"><span class="glyphicon glyphicon-arrow-left" aria-hidden="true"  style="font-size:12px"></span></a>&nbsp;&nbsp;&nbsp;&nbsp;<button type="submit" class="btn" disabled="true" id="sbutton" style="height:30px; background-color:rgb(19, 104, 206); color:#fff;"><font style="font-size:12px;font-weight:bold"> Select</font></button>&nbsp;&nbsp;&nbsp;&nbsp;<button type="button" class="btn btn-default" onclick="frmreset()" style="height:30px"></span><font style="font-size:12px;font-weight:bold">Reset</font></button>&nbsp;&nbsp;&nbsp;&nbsp;<a href="account.php?q=quiz&step=2&eid=' . $eid . '&n=' . ($sn + 1) . '&t=' . $total . '" class="btn" style="height:30px; background-color:rgb(19, 104, 206); color:#fff;"><span class="glyphicon glyphicon-arrow-right" aria-hidden="true"  style="font-size:12px"></span></a></form><br><br>';
                                 } else if ($_GET["t"] == $_GET["n"]) {
                                     echo '<br /><a href="account.php?q=quiz&step=2&eid=' . $eid . '&n=' . ($sn - 1) . '&t=' . $total . '" class="btn" style="height:30px; background-color:rgb(19, 104, 206); color:#fff;"><span class="glyphicon glyphicon-arrow-left" aria-hidden="true"  style="font-size:12px"></span></a>&nbsp;&nbsp;&nbsp;&nbsp;<button type="submit" class="btn" disabled="true" id="sbutton" style="height:30px; background-color:rgb(19, 104, 206); color:#fff;"><font style="font-size:12px;font-weight:bold"> Select</font></button>&nbsp;&nbsp;&nbsp;&nbsp;<button type="button" class="btn btn-default" onclick="frmreset()" style="height:30px"></span><font style="font-size:12px;font-weight:bold">Reset</font></button>&nbsp;&nbsp;&nbsp;&nbsp;</form><br><br>';
                                 } else if ($_GET["t"] > $_GET["n"] && $_GET["n"] == 1) {
                                     echo '<br />&nbsp;&nbsp;&nbsp;&nbsp;<button type="submit" class="btn" disabled="true" id="sbutton" style="height:30px; background-color:rgb(19, 104, 206); color:#fff;"><font style="font-size:12px;font-weight:bold"> Select<font></button>&nbsp;&nbsp;&nbsp;&nbsp;<button type="button" class="btn btn-default" onclick="frmreset()" style="height:30px"></span><font style="font-size:12px;font-weight:bold">Reset</font></button>&nbsp;&nbsp;&nbsp;&nbsp;<a href="account.php?q=quiz&step=2&eid=' . $eid . '&n=' . ($sn + 1) . '&t=' . $total . '" class="btn" style="height:30px; background-color:rgb(19, 104, 206); color:#fff;"><span class="glyphicon glyphicon-arrow-right" aria-hidden="true"  style="font-size:12px"></span></a></form><br><br>';
                                 } else {
                                 }
                                 echo '</div>';
                     ...
                     <tr><td style="vertical-align:middle"><b>S.N.</b></td><td style="vertical-align:middle"><b>Quiz</b></td><td style="vertical-align:middle"><b>Total Questions</b></td><td style="vertical-align:middle"><b>Right</b></td><td style="vertical-align:middle"><b>Wrong<b></td><td style="vertical-align:middle"><b>Unattempted<b></td><td style="vertical-align:middle"><b>Score</b></td><td style="vertical-align:middle"><b>Action<b></td></tr>';
                         ...
                         while ($row = mysqli_fetch_array($q)) {
                             ...
                             $c++;
                             echo '<tr><td style="vertical-align:middle">' . $c . '</td><td style="vertical-align:middle">' . $title . '</td><td style="vertical-align:middle">' . $total . '</td><td style="vertical-align:middle">' . $r . '</td><td style="vertical-align:middle">' . $w . '</td><td style="vertical-align:middle">' . ($total - $r - $w) . '</td><td style="vertical-align:middle">' . $s . '</td><td style="vertical-align:middle"><b><a href="account.php?q=result&eid=' . $eid . '" class="btn" style="margin:0px;background:rgb(19, 104, 206);color:white">&nbsp;<span class="title1"><b>View Result</b></td></tr>';
                         }
                         echo '</table></div>';
                     }
                     if (@$_GET['q'] == 3) {
